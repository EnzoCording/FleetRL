...
model = TD3("MlpPolicy", vec_env, verbose=1, train_freq=1, tensorboard_log="./FleetRl_tensorboard/")

model.learn(total_timesteps=100000, reset_num_timesteps=False, tb_log_name="vec_TD3")
