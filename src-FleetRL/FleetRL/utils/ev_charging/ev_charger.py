...
class EvCharger:
    ...
    def charge(self, db: pd.DataFrame, num_cars: int, actions, episode: Episode,
               ...
               ev_conf: EvConfig, time_conf: TimeConfig, score_conf: ScoreConfig):
        ...
        for car in range(num_cars):
            ...
            if actions[car] >= 0:
                ...
                ev_total_energy_demand = (1 - episode.soc[car] * episode.soh[car]) * ev_conf.battery_cap  # total energy demand in kWh
