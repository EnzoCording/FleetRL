...
env = FleetEnv()
schedule_generator_lmd: ScheduleGenerator = ScheduleGenerator("./", schedule_type=ScheduleType.Utility, file_comment="one_ev_lmd")
schedule_generator_ct: ScheduleGenerator = ScheduleGenerator("./", schedule_type=ScheduleType.Utility, file_comment="one_ev_ct")
...
schedule_generator_lmd: ScheduleGenerator = ScheduleGenerator("./", schedule_type=ScheduleType.Utility, file_comment="one_ev_lmd", save_schedule=False)
schedule_generator_ct: ScheduleGenerator = ScheduleGenerator("./", schedule_type=ScheduleType.Utility, file_comment="one_ev_ct", save_schedule=False)
