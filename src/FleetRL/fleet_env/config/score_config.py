class ScoreConfig:
    ...
    def __init__(self):
        ...
        self.penalty_soc_violation = -2500
        self.clip_soc_violation = -1000
        self.penalty_overloading = -150
        self.clip_overloading = -1000
        ...
        self.penalty_invalid_action = -0.005
        self.penalty_overcharging = -0.0015
        self.clip_overcharging = -0.005
