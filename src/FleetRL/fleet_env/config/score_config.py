class ScoreConfig:
    ...
    def __init__(self):
        ...
        self.penalty_soc_violation = -50
        self.clip_soc_violation = -6
        self.penalty_overloading = -35
        self.clip_overloading = -3
        ...
        self.penalty_invalid_action = -0.1
        self.penalty_overcharging = -0.1
