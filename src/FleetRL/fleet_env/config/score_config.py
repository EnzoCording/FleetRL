class ScoreConfig:
    ...
    def __init__(self):
        self.price_multiplier = 20
        self.penalty_soc_violation = -75
        self.clip_soc_violation = -7
        self.penalty_overloading = -50
        self.clip_overloading = -4
        ...
        self.penalty_overcharging = -0.01
